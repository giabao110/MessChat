...
//        let member = Member(name: "bluemoon", color: .blue)
    ...
    private func presentInputActionSheet() {
        let actionSheet = UIAlertController(title: "Attach Media",
                                            message: "What would you like to attche",
                                            preferredStyle: .actionSheet)
        
        actionSheet.addAction(UIAlertAction(title: "Photo", style: .default, handler: { [weak self] _ in
            self?.presetPhotoInputActionSheet()
        }))
    ...
    private func presetVideoInputActionSheet() {
    ...
    private func listenForMessage(id: String, shouldScrollToBottom: Bool) {
        DatabaseManager.share.getAllMessagesForConversation(with: id, completion: { [weak self] result in
            switch result {
...
extension ChatViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
        ...
        if let image = info[.editedImage] as? UIImage, let imageData = image.pngData() {
            ...
            // Upload image
            StorageManager.share.uploadMessagePhoto(with: imageData, fileName: fileName, completion: { [weak self] result in
